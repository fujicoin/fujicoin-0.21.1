...
After [#10102](https://github.com/fujicoin/fujicoin/pull/10102), the `-debug=ipc` command line option can be used to see requests and responses between processes.
